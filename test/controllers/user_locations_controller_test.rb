...
class UserLocationsControllerTest < ActionController::TestCase
  ...
  test "should create user_location" do
    assert_difference('UserLocation.count') do
      post :create, user_location: { address: @user_location.address, latitude: @user_location.latitude, longitude: @user_location.longitude }
    end
  ...
  test "should update user_location" do
    patch :update, id: @user_location, user_location: { address: @user_location.address, latitude: @user_location.latitude, longitude: @user_location.longitude }
    assert_redirected_to user_location_path(assigns(:user_location))
  end
